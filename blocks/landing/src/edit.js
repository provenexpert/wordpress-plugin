...
export default function Edit( object ) {
   ...
   * @param object
   */
  const onChangeAvatar = ( newValue, object ) => {
    object.setAttributes( { avatar: newValue } );
  }
   ...
   * @param object
   */
  const onChangeCompetence = ( newValue, object ) => {
    object.setAttributes( { competence: newValue } );
  }
